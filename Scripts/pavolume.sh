#!/usr/bin/env bash
# by https://customlinux.blogspot.de/2013/02/pavolumesh-control-active-sink-volume.html 
# modified at: https://github.com/jaagr/polybar/wiki/User-contributed-modules#pulseaudio-volume
# then by ecly
