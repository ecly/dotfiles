...
local M = {
    ...
    dependencies = {
        ...
        "lukas-reineke/cmp-under-comparator", "hrsh7th/cmp-vsnip",
        "rafamadriz/friendly-snippets", "hrsh7th/vim-vsnip",
        "hrsh7th/vim-vsnip-integ", "onsails/lspkind-nvim", "hrsh7th/cmp-calc",
    ...
    config = function()
        ...
        cmp.setup({
            ...
            sources = cmp.config.sources({
                ...
                {name = "buffer", keyword_length = 3}, {name = "async_path"},
