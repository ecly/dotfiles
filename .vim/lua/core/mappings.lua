...
wk.add({
    ...
    { "<leader>D", "<cmd>lua vim.lsp.buf.type_definition()<CR>", desc = "Type signature" },
    ...
    { "<leader>cf", '<cmd>lua require"conform".format({lsp_fallback = true})<CR>', desc = "Format" },
    ...
    { "<leader>fn", "<cmd>NvimTreeFindFile<CR>", desc = "Find current file in tree" },
    ...
    { "<leader>gr", "<cmd>lua vim.lsp.buf.references()<CR>", desc = "Go to reference" },
    ...
    { "<leader>l", group = "LSP" },
    { "<leader>lD", "<cmd>lua vim.diagnostic.open_float()<CR>", desc = "List diagnostics in float" },
    { "<leader>ld", "<cmd>lua vim.diagnostic.setloclist()<CR>", desc = "List diagnostics in loclist" },
    ...
    { "<leader>wl", "<cmd>lua vim.lsp.buf.(list_workspace_folders)<CR>", desc = "List workspaces" },
